...
### Complete reducers/index.js
  ...
  * [XX] Adds the following state values into the initialState:
      - an array of smurfs
      - a boolean indicating if the app is loading
      - a string indicating a possible error message

  * [XX] Add in the arguments needed to complete a standard reducer function.
  * [XX] Add in a reducer case to accommodate the start of a smurf fetch.
